...
def fix_database():
    ...
    try:
        ...
        # First, update any existing 'Pending' status to 'Booked'
        print("🔄 Updating existing 'Pending' status to 'Booked'...")
        ...
        if updated_count > 0:
            ...
            print("✅ No pending bookings found to update")
...
if __name__ == "__main__":
    print("🚀 Starting robust database schema fix...")
    fix_database() 